...
// Register a new user
router.post('/register', authUtils.protectRegisterEndpoint, validateUser, asyncHandler(async (req, res) => {
...
router.post('/forgot-password', asyncHandler(async (req, res) => {
  ...
  res.json({
    ...
    ...(process.env.NODE_ENV === 'development' && { resetToken, username: user.username })
  });
}));
